        ...
        <div className={`flex flex-col items-center justify-center h-screen bg-[#F9F5EA]`}>
            ...
            {!isVisible && (
                <div className={`homeContainer fade-in flex flex-col justify-center items-center w-full h-screen text-[#545454]`}>
                    ...
                    <h1 className='lg:text-9xl md:text-9xl min-[320px]:text-5xl sm:text-9xl text-green-500 z-10'>hngrPac</h1>
                    <p className='text-xl mt-[5%] z-10'>Wondering that to eat?</p>
                    <Link className='text-[#000] border rounded-xl bg-[#FFB897] hover:text-[#000] hover:bg-[#f7d7c9] py-2 px-2 duration-500 mt-5 z-10' to="/timeSearch">Perform Fast Search</Link>
                    <div className='pacmanIcon fixed bg-transparent lg:w-[100px] lg:bottom-[21%] lg:left-[47.5%]  md:bottom-[20%] md:left-[46%] sm:bottom-[20%] sm:left-[43%] min-[320px]:bottom-[28%] min-[320px]:left-[38%]'></div>
